...
<a style="text:decoration:none;color:red" href="./dashboard.php?loggedin=1"><input style="margin-left:90%;color:blue;width:100px;height:40px;" type="button" value="To dashboard"></a>
