...
<?php
        $usn=$_SESSION['id'];
        $name = $_SESSION['pass'];
        $sql = "SELECT cafeteria.name,it_no,buys.id,buys.quantity FROM buys INNER JOIN cafeteria ON buys.it_no = cafeteria.id";
...
<!-- Side panal -->
    ...
    <h5 style='margin-top:-13%;margin-left:45%;color:whitesmoke;'>Admin</h5>
     ...
     <p style='color:white;font-weight:100;'><i class="fas fa-tachometer-alt" style='color:white;margin-left:35px;'></i><a style="text-decoration:none;color:white"href="dashboard.php?loggedin=1">&nbsp&nbsp&nbsp Dashboard</a></p>
     <hr class='bg-light' style='margin-top:11%;width:11em;'>
